...
### Web dev
  - Basic CRUD thingy with Rust [Rocket](https://github.com/Zayac-The-Engineer/rocket-example) / [Yew](https://github.com/Zayac-The-Engineer/yew-example) and sqlx

### Game dev
  - I don't know if this actually counts as game dev, but here's [Conway's game of Life in Zig/SDL2](https://github.com/Zayac-The-Engineer/zig4lyfe)
  - An unfinished [WASM4 breakout type thing](https://github.com/Zayac-The-Engineer/central-breakout)
